...
public CourseBatch(Long id, Long course_id, String course_name, String course_level, String coordinator,
...
public String toString() {
	return "CourseBatch [id=" + id + ", course_id=" + course_id + ", course_name=" + course_name + ", course_level="
			...
			+ ", course_end_date=" + course_end_date + ", certificate_issuedate=" + certificate_issuedate + ", status="
